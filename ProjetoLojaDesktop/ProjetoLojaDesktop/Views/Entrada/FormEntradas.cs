...
namespace ProjetoLojaDesktop.Forms
{
    public partial class FormEntradas : Form
    {
        ...
        {
            dgvProdutosEntrada.DataSource = transacaoProductData.obterTransacaoPorId(entrada.idTransacao);
        ...
        {
            var lista = from tp in transacaoProductData.todasTransacoes()
        ...
        private void btnExcluirProduto_Click(object sender, EventArgs e)
        {
            ...
            string erro = transacaoProductData.excluirTransacaoProduto(getTransacaoSelecionada());
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            if (novoProduto == true)
            {
                erro = transacaoProductData.adicionarTransacaoProduto(transacaoProduto);
            }
            else
            {
                erro = transacaoProductData.editarTransacaoProduto(transacaoProduto);
            }
            if (erro == null)
            {
        ...
        {
            tabListaEntradas.SelectedIndex = 1;
            ((Control)this.tabListaEntradas).Enabled = true;
            resetarCampos();
            resetarCamposProduto();
            esconderCampos();
            novaEntrada = true;
        ...
        private void btnRegistrarEntrada_Click(object sender, EventArgs e)
        {
            ...
            if (erro == null)
            {
                ...
                idEntrada = entrada.idTransacao;
                obterNotaFiscal();
                nFiscalData.adicionarNotaFiscal(notaFiscal);
                novoProduto = false;
                btnSelProduto.Enabled = false;
                inicializarDataGridViewListaEntradas();
                exibirCampos();
        ...
        private void tabListaEntradas_Click(object sender, EventArgs e)
        {
            resetarCampos();
            resetarCamposProduto();
            txtDataEntrada.Enabled = false;
